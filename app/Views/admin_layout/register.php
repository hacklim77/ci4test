                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" name="password1" id="password1" type="password" placeholder="Create a password" />
                                                        <label>Password</label>
                                                        <small class="text-danger"><?= validation_show_error('password1') ?></small>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <small class="text-danger"><?= validation_show_error('password2') ?></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?= base_url('/login666') ?>">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
